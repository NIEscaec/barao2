---
title: "Brasil-CELAC, Dados Comerciais"
...
- \pagestyle{fancy}
- \fancyhead{}
- \fancyhead[CO,CE]{Brasil-CELAC, Dados Comerciais}
- \fancyfoot[CO,CE]{}
...
```{r, fig.height=5}
  ...
  comerciobr_dados_corrente(pais, periodo) %>%
    ...
    ggplot2::labs(title = glue::glue("Brasil-CELAC, Fluxo de Com\u00e9rcio {frase}"),
...
```{r, fig.height=4.3}
  ...
  df %>%
    ...
    ggplot2::labs(title = glue::glue("Brasil-CELAC, pauta comercial, {frase}"),
                  x = NULL, y = NULL, caption = "Fonte: Minist\u00e9rio da Economia")
...
if (length(pais) > 1) {
  ...
  df %>%
    ...
    treemap::treemap(index = c("path", "no_sh4_por"),
                     ...
                     title = glue::glue("Brasil-CELAC, Propor\u00e7\u00e3o de Exporta\u00e7\u00f5es e Importa\u00e7\u00f5es {frase}"))
```
...
```{r, fig.height=7, fig.width=10}
  ...
  df %>%
    ...
    ggplot2::theme_minimal() +
    ggplot2::labs(title = glue::glue("Brasil-CELAC, evolu\u00e7\u00e3o do com\u00e9rcio, {frase}"),
...
if (periodo == "mensal") {
  ...
  df %>%
    ...
    dplyr::mutate(dplyr::across(dplyr::starts_with("val"), ~ formatar_valor_tabela_produto(.x))) %>%
...
```{r, fig.height=4.3}
  ...
  df %>%
    ...
    treemap::treemap(index = c("path", "no_sh4_por"),
                     ...
                     align.labels=list(c("center", "center"), c("left", "top")),
                     palette = ggthemes::tableau_color_pal('Tableau 10')(10),
                     title = glue::glue("Brasil-CELAC, Propor {frase}"))
```
